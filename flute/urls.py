...
urlpatterns = patterns('',
    ...
    url(r'^cluster/without_length$', 'analysis.views.show_cluster_without_length', name='cluster_without_length'),
    ...
    url(r'^distances/$', 'analysis.views.show_distances', name='distances'),
