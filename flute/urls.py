...
urlpatterns = patterns('',
    ...
    url(r'^cluster/$', 'analysis.views.show_main_cluster', name='main_cluster'),
    ...
    url(r'^composition/(\w+)/individual/$', 'analysis.views.composition_individual', name='composition_individual'),
