...
urlpatterns = patterns('',
    ...
    url(r'^pure_data/contour$', 'analysis.views.show_pure_data_contour', name='pure_data_contour'),
    url(r'^pure_data/durations$', 'analysis.views.show_pure_data_durations', name='pure_data_durations'),
    url(r'^pure_data/intervals$', 'analysis.views.show_pure_data_intervals', name='pure_data_intervals'),
    ...
    url(r'^composition/(\w+)/download/', 'analysis.views.download_composition', name='download_composition'),
    url(r'^composition/(\w+)/pure_data/', 'analysis.views.download_pure_data', name='download_pure_data'),
